const abi = [
  ...
  },
  {
    ...
    name: 'createMarket',
    inputs: [
      { name: '_marketURI', type: 'string', internalType: 'string' },
    ...
    inputs: [
      {
        name: '_args',
        type: 'tuple',
        internalType: 'struct IMarketFactory.InitializeArgs',
        components: [
  ...
  },
  {
    ...
    inputs: [],
    outputs: [
      { name: '', type: 'address', internalType: 'contract IMarketAMM' },
    ],
    stateMutability: 'view',
  },
  {
