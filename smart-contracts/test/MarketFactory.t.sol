...
contract MarketFactoryTest is Test {
    ...
    function setUp() public {
        ...
        (USDC,factoryProxy) = deployer.run(owner, owner, address(USDC));
        MockERC20(address(USDC)).mint(address(this), 1000000 ether);
    ...
    function test_createMarket_with_default_liquidity() external {
        ...
        uint256 feeBPS = 100;
        USDC.approve(address(factoryProxy), initialLiquidity);

        // Act
        address newMarket = factoryProxy.createMarket(
