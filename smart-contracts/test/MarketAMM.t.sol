...
contract MarketAMMTest is Test {
    ...
    /*//////////////////////////////////////////////////////////////
                            getSellOutcomeData
    //////////////////////////////////////////////////////////////*/
    function test_getSellOutcomeData_correctly_calculates_amount() external view {
        // Arrange
        uint256 shares = 190.909 ether;
        uint256 outcomeIndex = 0;
        ...
        // Act
        (uint256 amount) = marketAMM.getSellOutcomeData(
            shares, outcomeIndex, IMarketAMM.MarketPoolState({liquidity: liquidity, outcomeShares: outcomeShares})
        );

        // Assert
        assertApproxEqAbs(amount, 100 ether, 0.0001 ether);
    }

    function test_getSellOutcomeData_correctly_calculates_amount_balanced() external view {
        // Arrange
        uint256 shares = 211.1111 ether;
        uint256 outcomeIndex = 0;
    ...
    function test_getSellOutcomeData_correctly_calculates_large_shares() external view {
        // Arrange
        uint256 shares = 10909.0909 ether;
        uint256 outcomeIndex = 0;
        ...
        // Assert
        assertApproxEqAbs(amount, 10000 ether, 0.0001 ether);
    }
    ...
    function test_getOutcomePrice_correctly_calculates_price_unbalanced() external view {
        ...
        // Assert
        assertEq(price, 0.6e6);
    }

    function test_fuzz_getOutcomePrice(uint256 outcomeAShares, uint256 outcomeBShares) external view {
        // Arrange
        outcomeAShares = bound(outcomeAShares, 1, 999999999999999999e6);
        outcomeBShares = bound(outcomeBShares, 1, 999999999999999999e6);
