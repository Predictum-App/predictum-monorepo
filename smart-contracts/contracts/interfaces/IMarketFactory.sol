...
interface IMarketFactory {
    ...
    /**
     * @notice Emitted when the oracle resolver is set
     * @param oracleResolver The address of the oracle resolver
     */
    event OracleResolverSet(address indexed oracleResolver);

    /**
     * @notice Emitted when the USDC is set
     * @param usdc The address of the USDC
     */
     ...
     */
    function setOracleResolver(address _oracleResolver) external;
